...
#define OURMODNAME   "1_rmw_atomic_bitops"

MODULE_AUTHOR("Kaiwan N Billimoria");
MODULE_DESCRIPTION(
"LKP2E book:ch13/1_rmw_atomic_bitops: quick demo of the RMW atomic bitwise operators");
...
static inline void setmsb_optimal(int i)
{
	...
	SHOW_MEM(i, "optimal: via set_bit(7,&mem)");
	SHOW_DELTA(t2, t1);
}
...
static inline void setmsb_suboptimal(int i)
{
	...
	SHOW_MEM(i, "set msb suboptimal: 7,&mem");
	SHOW_DELTA(t2, t1);
}
